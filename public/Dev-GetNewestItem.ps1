function Dev-GetNewestItem {
    ...
    Write-Warning 'see:
        C:\Users\cppmo_000\Documents\2020\powershell\MyModules_Github\Ninmonkey.Console-dotsource\Get-NewestItem.ps1
        C:\Users\cppmo_000\Documents\2020\powershell\MyModules_Github\Ninmonkey.Console-dotsource\Get-NewestVSCodeProjects.ps1
        '
}
