function devNin_Edit-FunctionSource {
    <#
    .synopsis
    ...
    .example
        PS> Get-Command 'Get-Enum*' | Edit-FunctionSource_devNin
        PS> Alias 'Br' | Edit-FunctionSource_devNin
        PS> 'Br', 'ls' | Edit-FunctionSource_devNin
    .link
        Edit-ModuleSource
    #>
...
if ($TempDebugTest) {
    # Edit-FunctionSource_devNin goto
}
# Edit-FunctionSource_devNin goto -Verbose -Debug -InformationAction continue

if ($false) {
    $q = Edit-FunctionSource_devNin lsFd -InformationAction continue -ea break

    # Edit-FunctionSource_devNin 'Write-ConsoleLabel' -ov 'FuncSourceRes'

    H1 'test1: as param'
    Edit-FunctionSource_devNin 'Write-ConsoleLabel' -ov 'FuncSourceRes1' -PassThru

    H1 'test2: as pipe'$FuncSourceRes | Join-String -SingleQuote -sep ', ' Name
    'ls', 'hr', 'Write-ConsoleHeader', 'Find-Type'
    | Edit-FunctionSource_devNin 'Write-ConsoleLabel' -ov 'FuncSourceRes2' -PassThru
    ...
    # $res[0]
    # Edit-FunctionSource_devNin 'Write-ConsoleLabefl'
    # Edit-FunctionSource_devNin 'hr'
    'Write-ConsoleLabel' | Edit-FunctionSource_devNin -PassThru
    'Label' | Edit-FunctionSource_devNin -PassThru
    'label', 'fm', 'goto' | Edit-FunctionSource_devNin -PassThru
}
